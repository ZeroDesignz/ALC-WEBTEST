      ...
      >
        <Tab>
            ...
            <Face2>
              ...
              <span>
              <h1>Collect</h1> 
              <img src="ALC-WEBTEST/images/icons/collection.png" alt=" collection icon" />
              <text>
        ...
        <Tab>
            ...
            <Face2>
              ...
              <span>
              <h1>Stake</h1>
              <img src="ALC-WEBTEST/images/icons/stakeIcon.png" alt=" collection icon" />
              <text>
          ...
          <Tab>
            ...
            <Face2>
              ...
              <span> 
              <h1>Battle</h1>
              <img src="ALC-WEBTEST/images/icons/battleIcon.png" alt=" collection icon" />
              <text>
          ...
          <Tab>
            ...
            <Face2>
              ...
              <span> 
              <h1>Upgrade</h1>
              <img src="ALC-WEBTEST/images/icons/upgradeIcon.png" alt=" collection icon" />
              <text>
          ...
          <Tab>
            ...
            <Face2>
              ...
              <span> 
              <h1>Trade</h1>
              <img src="ALC-WEBTEST/images/icons/tradeIcon.png" alt=" collection icon" />
              <text>
          ...
          <Tab>
            ...
            <Face2>
              ...
              <span> 
              <h1>Wear</h1>
              <img src="ALC-WEBTEST/images/icons/wearIcon.png" alt=" collection icon" />
              <text>
